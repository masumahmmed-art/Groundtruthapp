    ...
    <div>
      ...
      <div className="section" id="risk-location">
        ...
        <div className="card" style={{ padding: "18px 22px" }}>
          ...
          <p>
            <b>Site & investigation risk</b> adds two project-specific factors most estimators
            price by instinct: whether the site is <b>greenfield</b> or <b>brownfield</b>, and how
            much site investigation has actually been done. For a brownfield site, enter how many
            separate services were identified in your Dial Before You Dig referral — more
            services found suggests a higher probability of an unplanned utility strike.
            Separately, choosing your investigation level — <b>Minimal</b> (desktop study only),
            <b> Some</b> (preliminary boreholes or test pits), or <b>Detailed</b> (comprehensive
            investigation) — suggests a probability of hitting latent conditions the investigation
            didn't pick up: naturally higher for a minimal investigation, lower for a detailed one.
            As with every lookup below, only the probability and description are suggested — you
            still set the cost impact yourself before adding either to the register.
          </p>
          <p>
