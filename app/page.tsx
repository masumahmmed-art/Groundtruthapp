    ...
    <div className="landing">
      ...
      <section className="landing-hero">
        ...
        <p className="landing-lead">
          Ground Truth Estimator is a workspace for civil infrastructure companies to
          price projects the way a good estimator actually does it: labour, plant, and
          material rates assembled into build-ups, rolled up into categories, and
          stress-tested against a real risk register — not a single number pulled from
          memory.
        </p>
